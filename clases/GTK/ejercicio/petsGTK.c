...
void darAltaMascota(GtkWidget *pBotInsertar, gpointer pMiApp);
...
int main(int argc, char *argv[])
{
    ...
    g_signal_connect(G_OBJECT(miApp.botonIzq), "clicked", GTK_SIGNAL_FUNC(recorrerIzq), &miApp);
    g_signal_connect(G_OBJECT(miApp.botonDer), "clicked", GTK_SIGNAL_FUNC(recorrerDer), &miApp);
