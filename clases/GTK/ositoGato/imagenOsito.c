...
gint main(gint argc, gchar *argv[])
{
    ...
    gtk_window_set_title(GTK_WINDOW(window),"Ejemplo de imágenes");
    ...
    gtk_signal_connect(GTK_OBJECT(button),"clicked",GTK_SIGNAL_FUNC(ChangeImage), image);
